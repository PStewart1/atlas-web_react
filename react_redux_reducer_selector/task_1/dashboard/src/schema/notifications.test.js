...
describe("getAllNotificationsByUser", () => {
  ...
  it("verifies that your normalized data has a correct result array.", () => {
  ...
  it("verifies that your normalized data has a correct users entity", () => {
  ...
  it("verifies that your normalized data has a correct messages entity", () => {
  ...
  it("verifies that your normalized data has a correct notifications entity", () => {
